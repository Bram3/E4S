...
public:
   ...
   * unchanged. Also all characters written on the display will return, when the
   * display in enabled again.
   */
  void noDisplay();

  /**
   * Show the characters on the LCD display, this is the normal behaviour. This
   * method should only be used after noDisplay() has been used.
   */
  void display();
