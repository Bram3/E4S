...
public:
  ...
  // Attributes about a device or family of devices (if the attributes are
  // shared).
  struct Attributes {
  ...
  inline static float convertCtoF(float c) { return c * 1.8 + 32; }

  inline static float convertFtoC(float f) { return (f - 32) / 1.8; }
...
protected:
  ...
  void setInternalResolution(uint8_t resolution) {
    ...
    this->resolution_mask =
        ~(uint16_t)((1 << (attributes->temperature_width - resolution)) - 1);
  }
...
public:
  Temperature_LM75_Derived(TwoWire *bus, uint8_t i2c_address,
                           Attributes *attributes) {
    this->bus = bus;
  ...
  float readTemperatureC() {
    return convertIntegerTemperature(
        readIntegerTemperatureRegister(attributes->registers->temperature));
  }

  float readTemperatureF() { return convertCtoF(readTemperatureC()); }

  float readTemperatureLowC() {
    return convertIntegerTemperature(
        readIntegerTemperatureRegister(attributes->registers->temperature_low));
  }

  float readTemperatureLowF() { return convertCtoF(readTemperatureLowC()); }

  void setTemperatureLowC(float value) {
    writeIntegerTemperatureRegister(attributes->registers->temperature_low,
                                    convertFloatTemperature(value));
  }
  ...
  float readTemperatureHighC() {
    return convertIntegerTemperature(readIntegerTemperatureRegister(
        attributes->registers->temperature_high));
  }

  float readTemperatureHighF() { return convertCtoF(readTemperatureHighC()); }

  void setTemperatureHighC(float value) {
    writeIntegerTemperatureRegister(attributes->registers->temperature_high,
                                    convertFloatTemperature(value));
  }
...
public:
  ...
  Generic_LM75_Compatible(TwoWire *bus, uint8_t i2c_address,
                          Attributes *attributes)
...
public:
  Generic_LM75_10Bit(TwoWire *bus = &Wire,
                     uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
      : Generic_LM75_Compatible(bus, i2c_address,
                                &Generic_LM75_10Bit_Attributes){};

  Generic_LM75_10Bit(uint8_t i2c_address)
      : Generic_LM75_Compatible(&Wire, i2c_address,
                                &Generic_LM75_10Bit_Attributes){};
};
...
public:
  Generic_LM75_11Bit(TwoWire *bus = &Wire,
                     uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
      : Generic_LM75_Compatible(bus, i2c_address,
                                &Generic_LM75_11Bit_Attributes){};
...
public:
  Generic_LM75_12Bit(TwoWire *bus = &Wire,
                     uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
      : Generic_LM75_Compatible(bus, i2c_address,
                                &Generic_LM75_12Bit_Attributes){};
...
public:
  ...
  Generic_LM75_9_to_12Bit_Compatible(TwoWire *bus, uint8_t i2c_address,
                                     Attributes *attributes)
...
public:
  Generic_LM75_9_to_12Bit(TwoWire *bus = &Wire,
                          uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
      : Generic_LM75_9_to_12Bit_Compatible(bus, i2c_address,
                                           &Generic_LM75_12Bit_Attributes){};

  Generic_LM75_9_to_12Bit(uint8_t i2c_address)
      : Generic_LM75_9_to_12Bit_Compatible(&Wire, i2c_address,
                                           &Generic_LM75_12Bit_Attributes){};
};
...
public:
  ...
  OnSemi_NCTx75(uint8_t i2c_address) : Generic_LM75_12Bit(&Wire, i2c_address){};
...
class Generic_LM75_9_to_12Bit_OneShot_Compatible
    : public Generic_LM75_9_to_12Bit_Compatible {
private:
  enum ConfigurationBits {
...
public:
  Generic_LM75_9_to_12Bit_OneShot_Compatible(TwoWire *bus, uint8_t i2c_address,
                                             Attributes *attributes)
...
class Generic_LM75_9_to_12Bit_OneShot
    : public Generic_LM75_9_to_12Bit_OneShot_Compatible {
public:
  Generic_LM75_9_to_12Bit_OneShot(TwoWire *bus = &Wire,
                                  uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
      : Generic_LM75_9_to_12Bit_OneShot_Compatible(
            bus, i2c_address, &Generic_LM75_12Bit_Attributes){};

  Generic_LM75_9_to_12Bit_OneShot(uint8_t i2c_address)
      : Generic_LM75_9_to_12Bit_OneShot_Compatible(
            &Wire, i2c_address, &Generic_LM75_12Bit_Attributes){};
};
...
private:
  ...
  void setExtendedConfigurationBitValue(uint16_t value, uint8_t start,
                                        uint8_t width);

public:
  TI_TMP102_Compatible(TwoWire *bus = &Wire,
                       uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
      : Generic_LM75_9_to_12Bit_OneShot_Compatible(bus, i2c_address,
                                                   &TI_TMP102_Attributes){};

  TI_TMP102_Compatible(uint8_t i2c_address)
      : Generic_LM75_9_to_12Bit_OneShot_Compatible(&Wire, i2c_address,
                                                   &TI_TMP102_Attributes){};

  void setConversionRate(enum ConversionRate rate) {
    setExtendedConfigurationBitValue(
        rate, ExtendedConfigurationBits::ConversionRate, 2);
  }

  bool checkAlert() {
    return checkExtendedConfigurationBits(
        bit(ExtendedConfigurationBits::Alert));
  }
