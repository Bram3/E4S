...
int16_t Temperature_LM75_Derived::readIntegerTemperatureRegister(
...
void Temperature_LM75_Derived::writeIntegerTemperatureRegister(
    uint8_t register_index, int16_t value) {
  bus->beginTransmission(i2c_address);
...
void Generic_LM75_Compatible::writeConfigurationRegister(
...
void Generic_LM75_Compatible::setConfigurationBitValue(uint8_t value,
                                                       uint8_t start,
                                                       uint8_t width) {
  uint8_t configuration = readConfigurationRegister();
...
void TI_TMP102_Compatible::writeExtendedConfigurationRegister(
...
void TI_TMP102_Compatible::setExtendedConfigurationBitValue(uint16_t value,
                                                            uint8_t start,
                                                            uint8_t width) {
  uint16_t configuration = readExtendedConfigurationRegister();
